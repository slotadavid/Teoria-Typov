...
Proof.
(* Poznámka: Na zápis STLC termínov použite "exists <{ ... }>", 
   na zápis STLC typov použite "exists <{{ ... }}>". *)
Admitted.
...
induction H; intros T' H'; inversion H'; subst; try reflexivity.
Admitted.
